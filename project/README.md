# Программа динамического кодирования и декодирования данных по алгоритму Хаффмана с возможностью пошаговой демонстрации и консольно-файловым интерфейсом.
